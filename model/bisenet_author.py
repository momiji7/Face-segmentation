...
from model.resnet_author import resnet101
...
class BiSeNet(nn.Module):
    def __init__(self, out_planes = 19, is_training = True,
                 criterion = None, pretrained_model='/search/speech/xz/resnet101_v1c.pth',
    ...
    def forward(self, data, label=None):
        ...
        return self.heads[-1](pred_out[2]), self.heads[1](pred_out[1]), self.heads[0](pred_out[0])
